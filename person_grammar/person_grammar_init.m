...
%[M, Y4_l] = model_add_nonterminal(M);
%[M, Y5_l] = model_add_nonterminal(M);
%[M, O1_l] = model_add_nonterminal(M);
%[M, O2_l] = model_add_nonterminal(M);
%[M, O3_l] = model_add_nonterminal(M);
%[M, O4_l] = model_add_nonterminal(M);
%[M, O5_l] = model_add_nonterminal(M);
%[M, Y1_r] = model_add_nonterminal(M);
%[M, Y2_r] = model_add_nonterminal(M);
%[M, Y3_r] = model_add_nonterminal(M);
%[M, Y4_r] = model_add_nonterminal(M);
%[M, Y5_r] = model_add_nonterminal(M);
%[M, O1_r] = model_add_nonterminal(M);
%[M, O2_r] = model_add_nonterminal(M);
%[M, O3_r] = model_add_nonterminal(M);
%[M, O4_r] = model_add_nonterminal(M);
%[M, O5_r] = model_add_nonterminal(M);
%
%[M, obl, dbl] = model_addrule(M, 'D', Y1_l, Y1_lf, ...
%                              defoffset, defparams, 'M');
%[M, obl, dbl] = model_addrule(M, 'D', Y1_r, Y1_rf, ...
...
%[M, Y4] = model_add_nonterminal(M);
%[M, Y5] = model_add_nonterminal(M);
%[M, O1] = model_add_nonterminal(M);
%[M, O2] = model_add_nonterminal(M);
%[M, O3] = model_add_nonterminal(M);
%[M, O4] = model_add_nonterminal(M);
%[M, O5] = model_add_nonterminal(M);
%
%[M, bl] = model_addrule(M, 'S', X, X_l, 0, {[0 0 0]}, 'M');
%M = model_addrule(M, 'S', X, X_r, 0, {[0 0 0]}, 'M', bl);
%M.learnmult(bl) = 0;
